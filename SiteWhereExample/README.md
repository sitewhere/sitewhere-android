...
* Google Play Services - Import from {ANDROID_SDK}/extras/google/google_play_service 
* Compatibility Library - Import from {ANDROID_SDK}/extras/android/support/v7/appcompat
